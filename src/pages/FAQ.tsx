...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Credit sweeps usually take 30–45 days to show significant results, with approximately 80% of negative items removed during this timeframe. Business credit building takes about 3–6 months to establish a solid foundation. The exact timeline depends on your starting point and the complexity of your credit situation."
    },
    {
      question: "Do you offer refunds?",
      answer: "No refunds are available once the process begins, due to the nature of credit disputes and the work already performed on your behalf. However, we stand behind our results and will work diligently to achieve the best possible outcome for your credit situation. We encourage you to ask any questions during your free consultation before starting."
    },
    {
      question: "What documents are required?",
      answer: "A valid government-issued ID and proof of address are required to begin the credit restoration process. We may also need access to your credit reports and any supporting documentation related to the negative items we'll be disputing. Additional documents may be requested based on your specific case."
    },
    {
      question: "What's included in the Credit Sweep service?",
      answer: "Our Credit Sweep service includes a comprehensive analysis of all three credit reports, strategic dispute filing for negative items, ongoing monitoring of dispute progress, and follow-up actions as needed. We target collections, charge-offs, late payments, bankruptcies, and other negative items that may be affecting your score."
    },
    {
      question: "How does the Business Credit 7-Step Program work?",
      answer: "Our program starts with business formation and registration, then moves through D-U-N-S number setup, establishing business credit files, opening trade line accounts, securing business credit cards, building vendor relationships, and finally accessing business funding opportunities. Each step builds upon the previous one to create a strong business credit profile."
    },
    {
      question: "Can you guarantee specific credit score improvements?",
      answer: "While we cannot guarantee specific score increases due to the varying nature of credit situations, our clients typically see significant improvements. Our proven methodology has helped remove negative items for thousands of clients, leading to better credit scores and improved financial opportunities."
    },
    {
      question: "What makes TruCredit different from other credit repair companies?",
      answer: "TruCredit offers transparent pricing with no hidden fees, proven results with an 80% success rate for negative item removal, personalized service tailored to your specific goals, and comprehensive business credit building services. We also provide ongoing support and education to help you maintain good credit long-term."
    },
    {
      question: "Do you work with all three credit bureaus?",
      answer: "Yes, we work with Experian, Equifax, and TransUnion to ensure comprehensive credit restoration. Different negative items may appear on different bureaus, so it's important to address all three to maximize your credit improvement potential."
    },
    {
      question: "What happens after my credit is restored?",
      answer: "After successful credit restoration, we provide guidance on maintaining your improved credit score, building positive credit history, and leveraging your better credit for loans, mortgages, and other financial opportunities. We also offer ongoing monitoring services to help you stay on track."
    }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="px-6 py-4 text-left text-navy-primary font-semibold hover:text-gold-accent">
                  {faq.question}
                </AccordionTrigger>
